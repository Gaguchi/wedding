	...
	<main data-scroll-container="">
		...
		<section class="content ">
			<p class="content__text" data-scroll="" data-scroll-speed="2">Так как большинство приезжает в Грузию
				...
				как пешком, так и на машине, а что еще круче – на фуникулёре. (<a href="https://goo.gl/maps/SgVNseL4k3URGtCS6">Адрес</a>)
				...
				любви можно прочитать <a href="https://www.radiovan.fm/station/article/20835">здесь</a>.
			</p>
			<div class="image-row">
				<div class="image-set">
		...
		<section class="content ">
			<p class="content__text" data-scroll="" data-scroll-speed="2">Продолжим дальше поэтический маршрут? Тогда
				...
				жизни. Позже он переедет в Москву, а по приезду в Грузию напишет:<br><span><em><br>«Только нога ступила
						в Кавказ, Я
						вспомнил, что я — грузин.»<br></em></span><br><img src="images/poem.jpg" alt="" srcset=""><br><br>а знаете ли вы, что
				Владимир Владимирович свободно
				разговаривал на грузинском?
				Чтобы выучить базовые слова и фразы – жми сюда (<a href="#">ссылка</a> на разговорник)
