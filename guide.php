...
<body class="demo-1 loading">
	...
	<main data-scroll-container="">
		...
		<section class="content content--numbered">
			<p class="content__text" data-scroll="" data-scroll-speed="2">Продолжим дальше поэтический маршрут? Тогда следующий по величине город Грузии – Кутаиси. Здесь
					родился Маяковский, здесь же располагается дом-музей поэта, где он родился и провел первые годы
					жизни. Позже он переедет в Москву, а по приезду в Грузию напишет:<br><span><em><br>«Только нога ступила в Кавказ, Я
					вспомнил, что я — грузин.»<br></em></span><br> (ссылка, фото) <br><br>а знаете ли вы, что Владимир Владимирович свободно
